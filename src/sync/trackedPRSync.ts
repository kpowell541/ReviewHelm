    ...
    for (const pr of Object.values(mergedPRs)) {
      ...
      try {
        await api.put(`/tracked-prs/${pr.id}`, {
          ...
          selfReviewed: pr.selfReviewed,
          reviewRoundCount: pr.reviewRoundCount,
          changesEverNeeded: pr.changesEverNeeded,
          reReviewed: pr.reReviewed,
          missCategory: pr.missCategory,
          missNote: pr.missNote,
