...
<body>
  ...
  <div class="issue-row">
    <span>🔴 Blockers</span><strong>${scores.issuesByServerity.blocker}</strong>
  </div>
  <div class="issue-row">
    <span>🟠 Majors</span><strong>${scores.issuesByServerity.major}</strong>
  </div>
  <div class="issue-row">
    <span>🟡 Minors</span><strong>${scores.issuesByServerity.minor}</strong>
  </div>
  <div class="issue-row">
    <span>⚪ Nits</span><strong>${scores.issuesByServerity.nit}</strong>
  </div>
  ...
  <div class="footer">
    Generated by PR Review Center · ${completedDate}
  </div>
</body>
</html>`;
}
