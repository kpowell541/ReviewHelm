...
export function mergeTrackedPR(
  ...
  return {
    ...
    missCategory: newer.missCategory ?? older.missCategory,
    missNote: mergeOptionalText(newer.missNote, older.missNote),
...
export function serializeTrackedPR(pr: TrackedPR): string {
  return JSON.stringify({
    ...
    missCategory: pr.missCategory ?? null,
    missNote: pr.missNote ?? null,
